...
// Ownership logic of the license contract 
...
contract owned {
  ...
  //Ownership is in this contract transferable - any conditions or limits can be added. 
...
contract LicenseToken is owned {
  enum LicenseType {SURVEYVIDEO, SURVEYPRO, CREWPRO}
  enum LicenseState {ACTIVE, INACTIVE, EXPIRED}
   
  uint constant LICENSE_LIFE_TIME = 365 days;
